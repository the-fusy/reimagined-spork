...
if ("serviceWorker" in navigator) {
  navigator.serviceWorker
    .register("/reimagined-spork/app-worker.js")
    .then(reg => {
...
// Env
// -----------------------------------------------------------------------------
const goappEnv = {"GOAPP_INTERNAL_URLS":"null","GOAPP_ROOT_PREFIX":"/reimagined-spork","GOAPP_STATIC_RESOURCES_URL":"/reimagined-spork","GOAPP_VERSION":"15a1a4fba5738df68ca6e8f3b77b55faba84e5b8"};
...
if (!/bot|googlebot|crawler|spider|robot|crawling/i.test(navigator.userAgent)) {
  ...
  WebAssembly.instantiateStreaming(fetch("/reimagined-spork/web/app.wasm"), go.importObject)
    .then(result => {
