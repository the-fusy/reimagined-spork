...
if ("serviceWorker" in navigator) {
  navigator.serviceWorker
    .register("/reimagined-spork/go-app/app-worker.js")
    .then(reg => {
...
// Env
// -----------------------------------------------------------------------------
const goappEnv = {"GOAPP_INTERNAL_URLS":"null","GOAPP_ROOT_PREFIX":"/reimagined-spork/go-app","GOAPP_STATIC_RESOURCES_URL":"/reimagined-spork/go-app","GOAPP_VERSION":"ecb0bd2c34b9d759853bdb3854dfc27e5d8d407f"};
...
if (!/bot|googlebot|crawler|spider|robot|crawling/i.test(navigator.userAgent)) {
  ...
  WebAssembly.instantiateStreaming(fetch("/reimagined-spork/go-app/web/app.wasm"), go.importObject)
    .then(result => {
